...
class NeoXArgs(*BASE_CLASSES):
    ...
    def build_tokenizer(self):
        raise RuntimeError("Just use huggingface tokenizer to set .tokenizer")
    ...
    def calculate_derived(self):
        ...
        if global_num_gpus is None:
            raise RuntimeError("ReLoRA dataloading does not support automatic setting of global_num_gpus to reduce the amount of megatron dependencies")
